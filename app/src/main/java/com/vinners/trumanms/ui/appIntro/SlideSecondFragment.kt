...
class SlideSecondFragment : Fragment() {
    ...
    fun initView(view: View) {
        ...
        title.text = getString(R.string.slide_2_title)
        description.text = getString(R.string.slide_2_des)
        slideImage.load(R.drawable.info_slide_img_2)
    }
}