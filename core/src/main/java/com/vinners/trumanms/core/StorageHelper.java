...
public class StorageHelper {
     ...
     * @param fileNameWithExtension file otpVerificationToken with extension (ex .jpg)
     * @return cache file
     */
     ...
     *
     * @param context               context
     * @param fileNameWithExtension file otpVerificationToken with extension
     * @return cache file
     */
     ...
     *
     * @param directoryName directory otpVerificationToken
     * @param imageName     image otpVerificationToken
     ...
     *
     * @param directoryName directory otpVerificationToken
     * @param imageName     image otpVerificationToken with extension
     * @return ref to file
     */
    ...
    public static File accessExternalPublicFile(Context context,@Nullable String imageName) {
